...
case class Task(id: Int, completableByType: CompletableByType, completableByValue: String, completedByEmail: Option[String], completedDate: Option[ZonedDateTime], state: State.State, prototype: Task.Prototype, data: Option[JsObject], requestId: Int)
